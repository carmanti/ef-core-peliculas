...
namespace efcorepeliculas.Migrations
{
    ...
    [Migration("20221128062204_Controller")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ef_core_peliculas.Entidades.Actor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ef_core_peliculas.Entidades.Cine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ef_core_peliculas.Entidades.CineOferta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2,
                            CineId = 4,
                            FechaFin = new DateTime(2022, 12, 3, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2022, 11, 28, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = 1,
                            CineId = 1,
                            FechaFin = new DateTime(2022, 12, 5, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2022, 11, 28, 0, 0, 0, 0, DateTimeKind.Local),
                            PorcentajeDescuento = 10m
                        });
                });

            modelBuilder.Entity("ef_core_peliculas.Entidades.Genero", b =>
                {
            ...
            modelBuilder.Entity("ef_core_peliculas.Entidades.Pelicula", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ef_core_peliculas.Entidades.PeliculaActor", b =>
                {
            ...
            modelBuilder.Entity("ef_core_peliculas.Entidades.SalaDeCine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeneroPelicula", b =>
                {
                    b.HasOne("ef_core_peliculas.Entidades.Genero", null)
                        .WithMany()
                        .HasForeignKey("GenerosIdentificador")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ef_core_peliculas.Entidades.Pelicula", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PeliculaSalaDeCine", b =>
                {
                    ...
                    b.HasOne("ef_core_peliculas.Entidades.SalaDeCine", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ef_core_peliculas.Entidades.CineOferta", b =>
                {
                    b.HasOne("ef_core_peliculas.Entidades.Cine", null)
                        .WithOne("CineOferta")
                        .HasForeignKey("ef_core_peliculas.Entidades.CineOferta", "CineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ef_core_peliculas.Entidades.PeliculaActor", b =>
                {
                    b.HasOne("ef_core_peliculas.Entidades.Actor", "Actor")
                        .WithMany("PeliculasActores")
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ef_core_peliculas.Entidades.Pelicula", "Pelicula")
                        .WithMany("PeliculasActores")
            ...
            modelBuilder.Entity("ef_core_peliculas.Entidades.SalaDeCine", b =>
                {
                    b.HasOne("ef_core_peliculas.Entidades.Cine", "Cine")
